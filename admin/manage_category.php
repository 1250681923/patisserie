...
<td align="left"><?php echo $rs["category"]?></td>
        <td align="center"><a href="save_category.php?act=del&id=<?php echo $rs["c_id"]?>" onClick="{if(confirm('确定删除吗?')){return true;}return false;}"><font color="#000000">删除</font></a> <a href="edit_category.php?act=edit&id=<?php echo $rs["c_id"]?>">修改</a></td>
      </tr>
      <?php
		 }
?>
