...
<?php
$id=$_GET["id"];
$sql="select * from sub_admin where admin_id='$id'";
...
<input type="hidden" name="id" value="<?php echo $id?>">
    <table cellpadding="0" cellspacing="0" border="0" width="100%" class="loginForm">
      <tr>
        <th width="150">账号</th>
        <td><span class="table">
 <input name="zh" type="text" id="zh" value="<?php echo $rs["zh"]?>">
      ...
      <tr>
        ...
        <td><span class="table">
<input name="mima" type="password" id="mima" value="<?php echo $rs["mima"]?>">
        <span class="STYLE1">*</span></span></td>
      </tr>
      <tr>
        <th><span class="table">姓名：</span></th>
        <td><span class="table">
          <input name="name" type="text" id="name" value="<?php echo $rs["name"]?>">
        <span class="STYLE1">*</span></span></td>
      </tr>
      <tr>
        <th>电话:</th>
        <td><span class="table">
          <input name="tel" type="text" id="tel" value="<?php echo $rs["tel"]?>">
          <span class="STYLE1">*</span></span></td>
      </tr>
      <tr>
        <th>&nbsp;</th>
